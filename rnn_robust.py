...
training_set = dataset_train.iloc[:,3].as_matrix() # Using multiple predictors.
...
sc_predict.fit_transform(training_set)
...
n_past = 600  # Number of past days you want to use to predict the future
...
regressor.add(LSTM(units=10, return_sequences=True, input_shape=(n_past, 1)))
